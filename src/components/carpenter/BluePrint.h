...
public:
  ...
  const BuildingBlock* getBlock1() const
  {
    return mBlock1;
  }
  const BuildingBlock* getBlock2() const
  {
    return mBlock2;
  }
  const AttachPoint* getAttachPoint1() const
  {
    return mPoint1;
  }
  const AttachPoint* getAttachPoint2() const
  {
    return mPoint2;
  }
...
inline bool BuildingBlock::isAttached() const
{
  return mAttached;
}
inline void BuildingBlock::setPosition(WFMath::Point<3> position)
{
  mPosition = position;
}
inline void BuildingBlock::setOrientation(WFMath::Quaternion orientation)
{
  mOrientation = orientation;
}
inline const WFMath::Point<3>& BuildingBlock::getPosition() const
{
  return mPosition;
}
inline const WFMath::Quaternion& BuildingBlock::getOrientation() const
{
  return mOrientation;
}
inline const BuildingBlockSpec* BuildingBlock::getBuildingBlockSpec() const
{
  return mBuildingBlockSpec;
}
inline int BuildingBlock::getNumberOfChildBindings() const
{
...
inline Carpenter* const BluePrint::getCarpenter()
{
  return mCarpenter;
}
inline const std::string& BluePrint::getName() const
{
  return mName;
}
inline const BuildingBlock* BluePrint::getStartingBlock() const
{
