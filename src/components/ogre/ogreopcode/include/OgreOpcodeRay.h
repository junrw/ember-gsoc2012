...
public:
  ...
  /// Full constructor
  Ray3(Ogre::Real ox, Ogre::Real oy, Ogre::Real oz, Ogre::Real dx, Ogre::Real dy, Ogre::Real dz) :
  ...
  /// Setups this ray
  void set(Ogre::Real ox, Ogre::Real oy, Ogre::Real oz, Ogre::Real dx, Ogre::Real dy, Ogre::Real dz)
  {
    origin.x = ox;
    origin.y = oy;
    origin.z = oz;
  ...
  /// Sets the origin of this ray
  void setOrigin(const Ogre::Vector3& v)
  {
    origin = v;
  }
