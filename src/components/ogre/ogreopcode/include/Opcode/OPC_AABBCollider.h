...
protected:
  ...
  // Overlap tests
  inline_
  BOOL AABBContainsBox(const IceMaths::Point& bc, const IceMaths::Point& be);inline_
  BOOL AABBAABBOverlap(const IceMaths::Point& b, const IceMaths::Point& Pb);inline_
  BOOL TriBoxOverlap();
  // Init methods
