...
public:
  ...
  inline_
  HPoint& Set(float _x, float _y, float _z, float _w)
  {
    x = _x;
    y = _y;
    z = _z;
  ...
  //! Add a vector
  inline_
  HPoint& Add(float _x, float _y, float _z, float _w)
  {
    x += _x;
    y += _y;
    z += _z;
  ...
  //! Subtract a vector
  inline_
  HPoint& Sub(float _x, float _y, float _z, float _w)
  {
    x -= _x;
    y -= _y;
    z -= _z;
  ...
  inline_
  HPoint operator*(float s) const
  {
    return HPoint(x * s, y * s, z * s, w * s);
  }
  //! Operator for HPoint Scale = float * HPoint;
  inline_
  friend HPoint operator*(float s, const HPoint& p)
  {
  ...
  inline_
  float operator|(const HPoint& p) const
  {
