...
public:
  ...
  // Common settings
  inline_
  MeshInterfaceType GetInterfaceType() const
  {
    return mMIType;
  }
  inline_
  ...
  inline_
  udword GetNbVertices() const
  {
    return mNbVerts;
  }
  inline_
  udword GetNbRows() const
  {
    return 1 + mNbTris / (2 * (mNbVerts - 1));
  }
  inline_
  ...
  inline_
  void SetInterfaceType(MeshInterfaceType mit)
  {
    mMIType = mit;
  }
   ...
   */
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bool SetPointers(const IceMaths::IndexedTriangle* tris, const IceMaths::Point* verts);inline_
  const IceMaths::IndexedTriangle* GetTris() const
  {
    return mTris;
  }
  inline_
  const IceMaths::Point* GetVerts() const
  {
    return mVerts;
  }
...
#define OPC_UNPACK_VERTEX(K, ind )												 \
    ...
    case MESH_TRIANGLE:
      if (mTris) {
        ...
        OPC_UNPACK_VERTEX(1, T->mVRef[1])
        OPC_UNPACK_VERTEX(2, T->mVRef[2])
      } else { // support for non-indexed meshes
        index *= 3;
      ...
      //		 integer operations... shall we test performance??
    {
      ...
      // here we use a lookup table for a good tesselation
      udword lookup[4][3] = { { 0, mNbVerts + 1, 1 }, // case 0
          { 0, mNbVerts, mNbVerts + 1 }, // case 1
          { mNbVerts, mNbVerts + 1, 1 }, // case 2
          { 0, mNbVerts, 1 } // case 3	
      };
