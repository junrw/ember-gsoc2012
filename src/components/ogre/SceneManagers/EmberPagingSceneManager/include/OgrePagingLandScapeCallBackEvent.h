...
{
public:
  PagingLandscapeEvent(const size_t pagex, const size_t pagez, const size_t tilex, const size_t tilez, const Real* heightData, const AxisAlignedBox &Bbox) :
      mPagex(pagex), mPagez(pagez), mTilex(tilex), mTilez(tilez), mHeightData(heightData), mBbox(Bbox)
  {
