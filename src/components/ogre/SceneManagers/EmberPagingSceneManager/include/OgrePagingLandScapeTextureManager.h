...
public:
  ...
  ;
  void paint(const Vector3 &currpoint, const Real paintForce, const PagingLandScapeTileInfo *info);

  void deformHeight(const Vector3 &currpoint, const PagingLandScapeTileInfo *info);
  ...
  PagingLandScapeTexture* getTexture(const unsigned int i, const unsigned int j, const bool alwaysReturn = true);
