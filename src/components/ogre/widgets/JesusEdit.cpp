...
JesusEditPreview::JesusEditPreview(GUIManager* guiManager, Jesus* jesus) :
    mJesus(jesus), mConstruction(0), mGuiManager(guiManager), mBlueprint(0), mMinCameraDistance(0.5), mMaxCameraDistance(40), mSelectedAttachPointNode(0)
{
...
JesusEditFile::JesusEditFile(GUIManager* guiManager, JesusEdit* jesusEdit, Jesus* jesus) :
    mJesusEdit(jesusEdit), mJesus(jesus)
{
