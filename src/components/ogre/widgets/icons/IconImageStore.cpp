...
IconImageStore::IconImageStore(const std::string& imagesetName) :
    mImagesetName(imagesetName), mIconSize(64), mImageSize(256), mImageDataStream(OGRE_NEW Ogre::MemoryDataStream(mImageSize * mImageSize * 4, true)), mCeguiTexture(0), mImageset(0)
{
  createImageset();
  createEntries();
}
...
IconImageStore::IconImageStore(const std::string& imagesetName, Ogre::TexturePtr texPtr) :
    mImagesetName(imagesetName), mTexPtr(texPtr), mImageDataStream(0), mCeguiTexture(0), mImageset(0)
{
