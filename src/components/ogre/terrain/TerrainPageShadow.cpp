...
TerrainPageShadow::TerrainPageShadow(const TerrainPage& terrainPage) :
    mTerrainPage(terrainPage), mShadowTechnique(0), mLightDirection(WFMath::Vector<3>::ZERO()), mImage(new OgreImage(new Image::ImageBuffer(mTerrainPage.getAlphaTextureSize(), 1)))
{
}
