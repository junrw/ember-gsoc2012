...
Map::Map(Ogre::SceneManager& sceneManager) :
    mRenderTexture(0), mTexturePixelSize(256), mMetersPerPixel(1.0f), mCamera(*this, sceneManager), mView(*this, mCamera)
{
}
...
bool MapView::reposition(const Ogre::Vector2& pos)
{
  ...
  if (pos.x - halfViewSizeMeters < mFullBounds.left || pos.x + halfViewSizeMeters > mFullBounds.right || pos.y - halfViewSizeMeters < mFullBounds.bottom || pos.y + halfViewSizeMeters > mFullBounds.top) {
