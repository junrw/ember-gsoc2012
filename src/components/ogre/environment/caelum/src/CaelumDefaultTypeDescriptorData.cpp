...
CaelumDefaultTypeDescriptorData::CaelumDefaultTypeDescriptorData() :
    CaelumSystemTypeDescriptor(0), PointStarfieldTypeDescriptor(0), BaseSkyLightTypeDescriptor(0), GroundFogTypeDescriptor(0), PrecipitationTypeDescriptor(0), DepthComposerTypeDescriptor(0), FlatCloudLayerTypeDescriptor(0), SkyDomeTypeDescriptor(0)
{
  try {
    load();
  } catch (...) {
