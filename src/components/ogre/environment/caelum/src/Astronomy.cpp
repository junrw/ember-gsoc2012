...
void Astronomy::convertEclipticToEquatorialRad(LongReal lon, LongReal lat, LongReal &rasc, LongReal &decl)
{
...
void Astronomy::convertRectangularToSpherical(LongReal x, LongReal y, LongReal z, LongReal &rasc, LongReal &decl, LongReal &dist)
{
...
void Astronomy::convertSphericalToRectangular(LongReal rasc, LongReal decl, LongReal dist, LongReal &x, LongReal &y, LongReal &z)
{
...
void Astronomy::convertEquatorialToHorizontal(LongReal jday, LongReal longitude, LongReal latitude, LongReal rasc, LongReal decl, LongReal &azimuth, LongReal &altitude)
{
...
void Astronomy::getHorizontalSunPosition(LongReal jday, LongReal longitude, LongReal latitude, LongReal &azimuth, LongReal &altitude)
{
  ...
  Astronomy::convertEquatorialToHorizontal(jday, longitude, latitude, rasc, decl, azimuth, altitude);
}

void Astronomy::getHorizontalSunPosition(LongReal jday, Ogre::Degree longitude, Ogre::Degree latitude, Ogre::Degree &azimuth, Ogre::Degree &altitude)
{
  LongReal az, al;
...
void Astronomy::getEclipticMoonPositionRad(LongReal jday, LongReal &lon, LongReal &lat)
{
  ...
  lon = lprim + 0.1098L * sin(mprim) + 0.0222L * sin(2.0L * d - mprim) + 0.0115L * sin(2.0L * d) + 0.0037L * sin(2.0L * mprim) - 0.0032L * sin(m) - 0.0020L * sin(2.0L * f) + 0.0010L * sin(2.0L * d - 2.0L * mprim) + 0.0010L * sin(2.0L * d - m - mprim) + 0.0009L * sin(2.0L * d + mprim) + 0.0008L * sin(2.0L * d - m) + 0.0007L * sin(mprim - m) - 0.0006L * sin(d) - 0.0005L * sin(m + mprim);
  lat = +0.0895L * sin(f) + 0.0049L * sin(mprim + f) + 0.0048L * sin(mprim - f) + 0.0030L * sin(2.0L * d - f) + 0.0010L * sin(2.0L * d + f - mprim) + 0.0008 * sin(2.0L * d - f - mprim) + 0.0006L * sin(2.0L * d + f);
}

void Astronomy::getHorizontalMoonPosition(LongReal jday, LongReal longitude, LongReal latitude, LongReal &azimuth, LongReal &altitude)
{
  // Ecliptic spherical
...
void Astronomy::getHorizontalMoonPosition(LongReal jday, Ogre::Degree longitude, Ogre::Degree latitude, Ogre::Degree &azimuth, Ogre::Degree &altitude)
{
  LongReal az, al;
...
int Astronomy::getJulianDayFromGregorianDate(int year, int month, int day)
{
...
LongReal Astronomy::getJulianDayFromGregorianDateTime(int year, int month, int day, int hour, int minute, LongReal second)
{
...
LongReal Astronomy::getJulianDayFromGregorianDateTime(int year, int month, int day, LongReal secondsFromMidnight)
{
  int jdn = getJulianDayFromGregorianDate(year, month, day);
...
void Astronomy::getGregorianDateFromJulianDay(int julianDay, int &year, int &month, int &day)
{
...
void Astronomy::getGregorianDateTimeFromJulianDay(LongReal julianDay, int &year, int &month, int &day, int &hour, int &minute, LongReal &second)
{
...
void Astronomy::getGregorianDateFromJulianDay(LongReal julianDay, int &year, int &month, int &day)
{
  int hour;
  int minute;
  LongReal second;
