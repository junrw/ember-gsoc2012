...
const Vector3 gaLeafPolygonVertices[TREE_LEAFPOLYGONVERTICESNUMBER] = { Vector3(-0.5, 0.0, 0.0), Vector3(-0.5, 1.0, 0.0), Vector3(0.5, 1.0, 0.0), Vector3(0.5, 0.0, 0.0) };
...
const Vector3 gaCoordFrameVertices[TREE_COORDFRAMEVERTICESNUMBER] = { Vector3(1.00, 0.00, 0.00), Vector3(0.00, -0.03, -0.04), Vector3(0.00, -0.03, 0.04), Vector3(0.00, 0.05, 0.00), Vector3(0.00, 1.00, 0.00), Vector3(-0.04, 0.00, -0.03), Vector3(0.04, 0.00, -0.03), Vector3(0.00, 0.00, 0.05), Vector3(0.00, 0.00, 1.00), Vector3(-0.03, -0.04, 0.00), Vector3(-0.03, 0.04, 0.00), Vector3(0.05, 0.00, 0.00) };

const Vector3 gaCoordFrameNormals[TREE_COORDFRAMEVERTICESNUMBER] = { Vector3(1.0, 0.0, 0.0), Vector3(0.0, -0.6, -0.8), Vector3(0.0, -0.6, 0.8), Vector3(0.0, 1.0, 0.0), Vector3(0.0, 1.0, 0.0), Vector3(-0.8, 0.0, -0.6), Vector3(0.8, 0.0, -0.6), Vector3(0.0, 0.0, 1.0), Vector3(0.0, 0.0, 1.0), Vector3(-0.6, -0.8, 0.0), Vector3(-0.6, 0.8, 0.0), Vector3(1.0, 0.0, 0.0) };

const RGBA gaCoordFrameColors[TREE_COORDFRAMEVERTICESNUMBER] = { 0xA0FF0000, 0xA0FF0000, 0xA0FF0000, 0xA0FF0000, 0xA000FF00, 0xA000FF00, 0xA000FF00, 0xA000FF00, 0xA00000FF, 0xA00000FF, 0xA00000FF, 0xA00000FF };
