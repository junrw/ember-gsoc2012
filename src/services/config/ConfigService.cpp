...
ConfigService::ConfigService() :
    Service(), mSharedDataDir(""), mEtcDir(""), mHomeDir(""), mGlobalConfig(new varconf::Config()), mUserConfig(new varconf::Config()), mCommandLineConfig(new varconf::Config()), mInstanceConfig(new varconf::Config())
{
#ifdef __WIN32__
  char cwd[512];
