...
Service::Status SoundService::start()
{
  ...
  if (EmberServices::getSingleton().getConfigService().hasItem("audio", "enabled") && static_cast<bool>(EmberServices::getSingleton().getConfigService().getValue("audio", "enabled")) == false) {
